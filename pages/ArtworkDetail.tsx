    ...
    return (
        <div className="min-h-screen bg-[#08090a] pt-16 text-gray-200">
            ...
            <div className="relative w-full bg-[#050505] flex flex-col items-center pt-12 overflow-hidden border-b border-white/5">
                {/* Background Blur */}
                <div className="absolute inset-0 opacity-20 blur-[150px] scale-110 pointer-events-none overflow-hidden">
                    ...
                    <div className="lg:col-span-4 h-full flex flex-col justify-center">
                        <div className="bg-[#121417]/80 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 shadow-2xl space-y-8">
                            ...
                            <button
                                ...
                                className={`w-full py-5 rounded-2xl font-black text-xs uppercase tracking-widest transition-all shadow-xl flex items-center justify-center gap-3 disabled:bg-white/5 disabled:text-gray-500 disabled:border-white/10 disabled:shadow-none ${artwork.isOwned
