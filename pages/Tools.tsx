...
import ArtworkCropper from '../components/Tools/ArtworkCropper';
import GifOptimizer from '../components/Tools/GifOptimizer';
import ColorExtractor from '../components/Tools/ColorExtractor';
import WorkshopSlicer from '../components/Tools/WorkshopSlicer';
import SteamIDConverter from '../components/Tools/SteamIDConverter';
import AchievementBuilder from '../components/Tools/AchievementBuilder';
import LevelCalculator from '../components/Tools/LevelCalculator';
import InvisibleCharacter from '../components/Tools/InvisibleCharacter';
                        ...
                        >
                            <div className="relative z-10 flex flex-col h-full">
                                ...
                                <div className="flex items-center justify-between mb-6">
                                    ...
                                    <span className={`px-2 py-0.5 rounded-md text-[9px] font-black uppercase tracking-widest border ${tool.status === 'Beta' ? 'bg-yellow-500/20 text-yellow-400 border-yellow-500/40' :
                ...
                >
                    ...
                    <div className="flex-1 p-0">
                        {activeTool === 'cropper' ? (
                            ...
                            <AchievementBuilder />
                        ) : activeTool === 'level-calc' ? (
                            <LevelCalculator />
                        ) : activeTool === 'invisible' ? (
                            <InvisibleCharacter />
                        ) : activeTool === 'fancy-text' ? (
                            <FancyTextGenerator />
                        ) : (
                            <div className="h-full flex flex-col items-center justify-center text-center py-20 key={activeTool}">
